...
print("Response = " ,api.readBits(1,4))
...
print("Response = " ,api.writeWord(1,words[0]))
...
print("Response = " ,api.writeWords(2, words[1:]))
#Return the number of writed words if success
successCondition = response == "3"
conditionChecker(successCondition)
...
print("Response = " ,api.readWords(1,4))
